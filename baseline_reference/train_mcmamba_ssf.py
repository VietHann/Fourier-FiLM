#!/usr/bin/env python3
"""Train the DoA-conditioned MCMamba adaptation on the McNet-SSF data."""
...
from mcmamba_ssf import MCMambaSSF  # noqa: E402
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--version", default="mcmamba_ssf_sp1_bs12_500ep")
...
def main() -> None:
    ...
    config["derived"] = {
        ...
        "adaptation": "Published offline MCMamba stages plus SSF DoA conditioning",
        ...
        "steering": "DoA embedding added to first Bi-Mamba projected sequence",
    ...
    if int(os.environ.get("LOCAL_RANK", "0")) == 0:
        ...
        with (run_dir / "provenance.json").open("w", encoding="utf-8") as handle:
            json.dump(
                {
                    "model_class": "mcmamba_ssf.MCMambaSSF",
                    ...
                    "note": (
                        ...
                        "SSF steering; this run is a documented DoA-conditioned adaptation."
                    ),
                },
                handle,
                indent=2,
    ...
    model = MCMambaSSF(**network_config)
    experiment = SSFExp(
        model=model,
